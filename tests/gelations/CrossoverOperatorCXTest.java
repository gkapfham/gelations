 ...
 *
 */
public class CrossoverOperatorCXTest {
	...
	public void setUp() throws Exception {
		...
		crossoverOperator = new CrossoverOperatorCX(rng.nextLong());
	...
	/**
	 * Test method for {@link gelations.CrossoverOperatorCX#performCrossover(gelations.Individual, gelations.Individual)}.
	 */
	@Test
