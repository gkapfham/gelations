...
MakeLatticePlotCrossoverOperatorRS(Dataset, 
    ...
    filesuffix="CRSOP_MUTOP=ISM_MUTRT=0.1_CHLDR=1.0_FITOP=WIN_POPSZ=150_All",
...
MakeLatticePlotCrossoverOperatorRS(Dataset, 
    ...
    filesuffix="CRSOP_MUTOP=ISM_MUTRT=0.1_CHLDR=0.6_FITOP=EXP_POPSZ=50_All",
    datatype=1, color=FALSE)
...
MakeLatticePlotSelectionMethodRS(Dataset, 
    ...
    filesuffix="SELOP_MUTOP=ISM_MUTRT=0.1_CHLDR=1.0_FITOP=WIN_POPSZ=150_All",
    datatype=1, color=FALSE)
