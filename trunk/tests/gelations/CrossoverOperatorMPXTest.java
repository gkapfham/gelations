 ...
 *
 */
public class CrossoverOperatorMPXTest {
	...
	public void setUp() throws Exception {
		...
		crossoverOperator = new CrossoverOperatorMPX(rng.nextLong());
	...
	/**
	 * Test method for {@link gelations.CrossoverOperatorMPX#performCrossover(gelations.Individual, gelations.Individual)}.
	 */
	@Test
