 ...
 *
 */
public class MutationOperatorEMTest {
	...
	public void setUp() throws Exception {
		...
		mutationOperator = new MutationOperatorEM(rng.nextLong());
	...
	/**
	 * Test method for {@link gelations.MutationOperatorEM#mutateIndividual(gelations.Individual)}.
	 */
	@Test
