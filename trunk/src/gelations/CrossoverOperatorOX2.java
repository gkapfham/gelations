/**
 * Alexander Conrad
 * gelations.CrossoverOperatorOX2.java
 */
package gelations;
...
/**
 * This class performs crossover using the order based crossover 
 ...
 *
 */
public class CrossoverOperatorOX2 extends CrossoverOperator {
    ...
    public CrossoverOperatorOX2(int _positions, long seed) {
    ...
    public CrossoverOperatorOX2(int _positions) {
    ...
    public CrossoverOperatorOX2(long seed) {
	...
	//  opposite parents and copy in the cooresponding 
	//  elements
	//	note: the only difference between OX2 and POS: 
	//  OX2 iterates from 0 to length-positions in order to 
	//  fill in all but the selected positions; 
	//  POS iterates from 0 to positions to fill in only the 
	//  selected positions from the opposite parent.
	...
	//  present within the coresponding parent
	for (int i=0; i<length; i++) {
	    ...
	    if (!child0Chromosomes.containsKey(nextChrom0.getId())) {
