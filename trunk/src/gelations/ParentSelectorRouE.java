/**
 * Alexander Conrad
 * gelations.ParentSelectorRouE.java
 */
package gelations;
 ...
 *
 */
public class ParentSelectorRouE extends ParentSelector {

    public ParentSelectorRouE(long seed) {
		
	super(seed);
		
    }
    
    public ParentSelectorRouE() {
	...
	for (int i=0; i<individuals.size(); i++) {
		...
		double newFitness 
	    	= Math.sqrt(individual.getFitness() + 0.00001);
