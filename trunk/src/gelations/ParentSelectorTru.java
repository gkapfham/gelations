/**
 * Alexander Conrad
 * gelations.ParentSelectorTru.java
 */
package gelations;
 ...
 *
 */
public class ParentSelectorTru extends ParentSelector {
    ...
    public ParentSelectorTru(long seed) {
    ...
    public ParentSelectorTru(long seed, double _proportion) {
    ...
    public ParentSelectorTru(double _proportion) {
